...
#+RESULTS:
| (closure (t) nil (add-to-list company-backends '(company-my-lean-symbols company-capf)) (setq-local company-minimum-prefix-length 1)) | (lambda nil (add-to-list company-backends '(company-my-lean-symbols company-capf)) (set (make-local-variable 'company-minimum-prefix-length) 1)) | my-lean-key-chord-fix | lsp |
