...
#+begin_src emacs-lisp
	...
	;; 3. company-prescient is enabled via use-package in the Company section below
	;; (This replaces company-statistics and sorts Company candidates by frecency)
	)
...
#+BEGIN_SRC emacs-lisp
  (use-package smartparens
  	     ...
  	     (sp-pair  "⟨" "⟩" )
  	     (sp-local-pair 'lean4-mode "⟨" "⟩" :trigger "⟨")
   ...
   (use-package embrace
    :ensure t
    :config
    (add-hook 'lean4-mode (lambda () (embrace-add-pair ?\<  "⟨" "⟩" )))
